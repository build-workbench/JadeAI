...
/**
 * Stage a renamed copy of Electron.app so the dev app is called JadeAI.
 *
 ...
 * as "Electron" (verified: lsappinfo reported JadeAI while the dock still said
 * Electron). So the bundle itself has to be named JadeAI.app.
 *
...
function stageNamedDevBundle() {
  ...
  try {
    ...
    if (stale) {
      console.log('[dev] staging JadeAI.app');
